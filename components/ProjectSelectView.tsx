  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] w-full max-w-2xl mx-auto animate-fade-in-up">
      <div className="text-center mb-10">
        <h1 className="text-4xl font-bold tracking-tight text-gray-900 dark:text-white mb-3">Select Project</h1>
        <p className="text-gray-500 dark:text-gray-400 text-lg">Choose an active site to view financial metrics.</p>
      </div>
          ...
          <GlassCard
            ...
            className={`p-5 flex items-center justify-between group transition-all duration-200 ${
              selectedId === project.id 
                ? 'ring-2 ring-apple-blue bg-white dark:bg-gray-800' 
                : 'hover:bg-white/80 dark:hover:bg-gray-800/80'
            }`}
          >
            <div className="flex items-center gap-4">
              <div className={`p-3 rounded-full ${selectedId === project.id ? 'bg-blue-100 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400' : 'bg-gray-100 text-gray-500 dark:bg-gray-700 dark:text-gray-400'}`}>
      ...
      <button
        ...
        className={`
          ...
          ${selectedId 
            ? 'bg-apple-dark text-white hover:bg-black dark:bg-white dark:text-black dark:hover:bg-gray-200 transform hover:-translate-y-1 shadow-blue-500/20' 
